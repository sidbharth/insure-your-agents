 ...
 */
import { EXCLUSION_WALL, EXCLUSION_WALL_MANTRA } from '../data/copy';
  ...
  return (
    ...
    >
      <div className="border-b border-line-soft px-5 py-3">
        <h2 className="text-md">What is never covered</h2>
        <p className="mt-0.5 text-xs italic text-muted">“{EXCLUSION_WALL_MANTRA}”</p>
      </div>
